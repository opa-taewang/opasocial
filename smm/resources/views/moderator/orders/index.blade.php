...
@section('content')
    @php
        $status = $status ?? false;
        $dataURL = $status ? "/moderator/orders-filter-ajax/$status/data" : "/moderator/orders-ajax/data";
    @endphp
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 5px;">
            <div class="btn-group">
                <a href="{{ url('/moderator/orders/') }}" class="btn btn-default btn-sm btn btn-default btn-sm {{ $status == false ? 'active' : '' }}">ALL</a>
                <a href="{{ url('/moderator/orders-filter/pending') }}" class="btn btn-default btn-sm {{ $status == 'pending' ? 'active' : '' }}">Pending</a>
                <a href="{{ url('/moderator/orders-filter/inprogress') }}" class="btn btn-default btn-sm {{ $status == 'inprogress' ? 'active' : '' }}">In Progress</a>
                <a href="{{ url('/moderator/orders-filter/processing') }}" class="btn btn-default btn-sm {{ $status == 'processing' ? 'active' : '' }}">Processing</a>
                <a href="{{ url('/moderator/orders-filter/completed') }}" class="btn btn-default btn-sm {{ $status == 'completed' ? 'active' : '' }}">Completed</a>
                <a href="{{ url('/moderator/orders-filter/partial') }}" class="btn btn-default btn-sm {{ $status == 'partial' ? 'active' : '' }}">Partial</a>
                <a href="{{ url('/moderator/orders-filter/refunded') }}" class="btn btn-default btn-sm {{ $status == 'refunded' ? 'active' : '' }}">Refunded</a>
                <a href="{{ url('/moderator/orders-filter/cancelled') }}" class="btn btn-default btn-sm {{ $status == 'cancelled' ? 'active' : '' }} ">Cancelled</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form id="frm-apply-all" action="{{ url('/moderator/orders-bulk-update') }}" method="post">
                        {{ csrf_field() }}
                    </form>
