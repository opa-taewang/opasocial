    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="well">
                ...
                <form id="payment-form" role="form" method="POST" action="{{ url('/payment/add-funds/stripe') }}">
                    {{ csrf_field() }}
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group" style="padding-bottom: 0;margin-bottom:0">
                            ...
                            <input type="text" class="form-control" data-validation="required" id="card-holder-name" autocomplete="off">
                        </div>
                        <div class="form-group" style="padding-bottom: 0;margin-bottom:0">
                            <label class="control-label" for="card-number">@lang('forms.card_number')</label>
                            <input type="text" class="form-control" data-validation="required" id="card-number" autocomplete="off" size="20" maxlength="20">
                        </div>
                        <div class="form-group" style="padding-bottom: 0;margin-bottom:0">
                            <label class="control-label" for="expiry-month">@lang('forms.expiration')</label>
                            <div class="row">
                                <div class="col-xs-3">
                                    <input type="text" placeholder="MM" class="form-control" data-validation="required" autocomplete="off" size="2" maxlength="2" id="expiry-month">
                                </div>
                                <div class="col-xs-9" style="padding-left:0">
                                    <input type="text" placeholder="YYYY" autocomplete="off" data-validation="required" maxlength="4" class="form-control" id="expiry-year">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" style="padding-bottom: 0;margin-bottom:0">
                            <label class=" control-label" for="cvc">@lang('forms.cvs')</label>
                            <input type="text" class="form-control" autocomplete="off" size="3" data-validation="required" maxlength="3" id="cvc">
                        </div>
