        ...
        <div class="col-sm-12">
            <div class="well">
                <div style="text-align: left;">
                                            <img src="https://dvh1deh6tagwk.cloudfront.net/money-transfers/images/product/payoneerlogo-supplied-310x194.png?ver=20190830-161901&fit=600&webp=1" alt="Payoneer Logo"width="100"width="26" >

                </div>
<div class="text-center">
- Send Payment to <b>teamdcreato@gmail.com</b>.<br>
                - Minimum 10 USD.<br>
                - After sending, Just wait for 10-15 minutes for approval of Transaction.<br>
                - Enter Payment ID, Amount Below!<br>
                - Bonus 5%.
</div>
                <form id="payment-form"
                      role="form"
                      method="POST"
                      action="{{ url('/payment/add-funds/payoneer') }}">
                    {{ csrf_field() }}
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" style="padding-bottom: 0;margin-bottom:0">
                            <label class="control-label" for="transaction_id">Transaction ID [Example: 232891126]</label>
