    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="well">
                ...
                <form id="payment-form" role="form" method="POST" action="{{ url('/payment/add-funds/instamojo') }}">
                    {{ csrf_field() }}
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" style="padding-bottom: 0;margin-bottom:0">
                            ...
                            <input class="form-control" name="name" id="name" data-validation="required" type="text">
                            @if ($errors->has('name'))
                                <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}" style="padding-bottom: 0;margin-bottom:0">
                            ...
                            <input class="form-control" name="email" id="email" data-validation="email" type="text">
                            @if ($errors->has('email'))
                                <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}" style="padding-bottom: 0;margin-bottom:0">
                            ...
                            <input class="form-control" name="phone" id="phone" data-validation="required" type="text">
                            @if ($errors->has('phone'))
                                <span class="help-block">
