...
<html lang="en">
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      <!-- Basic Page Needs =====================================-->
          ...
          <link rel="shortcut icon" href="/images/cover.png">
      ...
      <![endif]-->
      <!--Custom CSS -->
      <link rel="stylesheet" href="/custom_main/19/css/custom.css">
...
<nav id="guest-nav" class="@if(Request::path() === 'signup') guestNav @endif navbar navbar-default navbar-static-top">
    <div class="container">
		...
		<div class="row">
			<div class="col-sm-6">
                ...
                @if(Session::has('error'))
                        ...
                        @endif
                <form class="home-form register-from" role="form" method="POST" action="{{ url('/signup') }}">
                    <div class="row pd-row">
                        <div class="col-sm-4">
                            <div class="form-group inputDiv {{ $errors->has('name') ? ' has-error' : '' }}">
                               <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" data-validation="required" placeholder="Name" autofocus>
                               @if ($errors->has('name'))
                        ...
                        <div class="col-sm-4">
                            <div class="form-group inputDiv {{ $errors->has('email') ? ' has-error' : '' }}">
                               <input id="email" type="email" class="form-control login-field" name="email" value="{{ old('email') }}" data-validation="email" placeholder="Email">
                               @if ($errors->has('email'))
                        ...
                        <div class="col-sm-4">
                            <div class="form-group inputDiv {{ $errors->has('username') ? ' has-error' : '' }}">
                               <input id="username" type="username" class="form-control login-field" name="username" value="{{ old('username') }}"  placeholder="Username">
                        ...
                        <div class="col-sm-3" style="display:none;">
                            <div class="form-group inputDiv">
                               <input id="skype_id" type="text" class="form-control login-field" name="skype_id" value="na" placeholder="Phone No.">
                            </div>
                        </div>
                    </div>
                    <div class="row pd-row">
                        <div class="col-sm-6">
                            <div class="form-group inputDiv mr-l secondRowFirstBacha{{ $errors->has('password') ? ' has-error' : '' }}">
                               <input id="password" type="password" class="form-control login-field" name="password" data-validation="required" placeholder="Password">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group inputDiv mr-l noAfter">
                               <input id="password-confirm" type="password" class="form-control login-field" name="password_confirmation" data-validation="required" placeholder="Confirm Password">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="btn-group">
                                <button type="submit" class="btn btn-primary">@lang('buttons.register') <i class="fas fa-sign-in-alt"></i></button>
                        ...
                        <div class="col-sm-5">
                            <span class="text-right">Already have an account? <a href="/login">Sign in</a></span>
                        </div>
                    </div>
                </form>
            </div>
...
<section id="why-us">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h2>Why Choose Us</h2>
                <p>We are the leading and #1 Social Media Marketing and SEO Experts in India and Now Available to the world.<br>All of our services are priced fairly, much lower price than any of our competitors in the market.<br>Test us, try Us, and then you will believe the power of OpaSocial, the SMM and SEO Experts. </p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
...
<br>But let us tell you why we are the first in what we do.</p>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <img src="/custom_main/19/images/feature.png">
            </div>
            <div class="col-sm-3">
...
<footer>
    <div class="footer-top">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <img class="footer-logo" src="{{ asset(getOption('logo')) }}" alt="footer-logo">
