...
<head>
    ...
    <script src="{{ asset('js/vendor/form-validator/jquery.form-validator.min.js') }}"></script>
</head>
<style>
    body {
            ...
            <div id="install-form">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <p>If facing problems, please contact support at <br><span class="text-primary">indusrabbit@hotmail.com</span></p>
                    </div>
                </div>
            </div>
        </div>
