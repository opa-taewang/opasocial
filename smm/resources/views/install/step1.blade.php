...
<center><img src="https://i.imgur.com/bNhzQ0T.png" alt="MXZ-SCRIPT" height="50" width="300">
<h5> MXZ-SCRIPT Installation Wizard</h5></center>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal"
                            ...
                            <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                <label for="username" class="col-sm-2 control-label">MXZ Username</label>
                                <div class="col-sm-8">
                                    <input type="username" class="form-control" id="username" value="{{ old('username') }}" name="username"  placeholder="username">
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('secretcode') ? ' has-error' : '' }}">
                                <label for="secretcode" class="col-sm-2 control-label">MXZ Secretcode</label>
                                <div class="col-sm-8">
                                    <input type="secretcode" class="form-control" id="secretcode" value="{{ old('secretcode') }}" name="secretcode"  placeholder="secretcode">
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group{{ $errors->has('license_code') ? ' has-error' : '' }}">
                                <label for="license_code" class="col-sm-2 control-label">License Code</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="license_code" name="license_code" value="{{ old('license_code') }}"  placeholder="license code">
                                </div>
                            </div>
