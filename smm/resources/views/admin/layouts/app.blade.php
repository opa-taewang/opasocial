    ...
    padding: 0;">
            ...
            <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu">
                                  <ul>
                <li>
                  <a href="{{ url('/admin/child-panels') }}">Configurations
                  </a>
                </li>
                                
                                            <li>
                  <a href="{{ url('/admin/child-panels/orders') }}">Panel Orders
                  </a>
                </li>
                            ...
                            <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu">
                                  <ul>
                <li>
                  <a href="{{ url('/admin/mprofit') }}">Monthly Profit
                  </a>
                </li>
                                
                                            <li>
                  <a href="{{ url('/admin/profit') }}">Daily Profit
                  </a>
                </li>
                            ...
                            <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu">
                                  <ul>
                <li>
                  <a href="{{ url('/admin/coupons') }}">All Coupons
                  </a>
                </li>
                <li>
                  <a href="{{ url('/admin/coupons/history') }}">Coupon History
                  </a>
                </li>
            ...
            <li>
                            ...
                            <li>
                                <a href="{{ url('admin/points-history') }}">
