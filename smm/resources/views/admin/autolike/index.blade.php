...
@section('content')
<a href="{{ URL::to('admin/remove_table/9') }}" class="btn btn-danger btn-sm" style="float: right;">Clear All Orders</a>
    <div class="row">
        <div class="col-md-12">
...
@push('scripts')
    ...
    var table = $('.mydatatable').DataTable({
                ...
                pageLength: 25,
                order: [ [1, 'desc'] ],
                ajax: '{!! url('/admin/autolike-index/data') !!}',
                columns: [
                    {
