...
@section('title', getOption('app_name') . ' - Banned Ips')
@section('content')
    <div class="row">
        <div class="col-md-12 mtn10">
            <div class="mb10">
                <a href="{{ url('/admin/ips/create') }}" class="btn btn-primary btn-sm">@lang('buttons.create_new')</a>
            </div>
