                            ...
                            <div class="form-group">
                                ...
                                <table class="table table-bordered" id="tbl-order-request">
                                    ...
                                    <tbody>
                                                                                                                                                                    <tr>
                                                <td>
                                                    <input type="text" name="order_key[]" value="api_token" class="form-control order-key" data-validation="required">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <button
                                                        ...
                                                        <span class="fui-trash"></span>
                                                                                                                                                                            ...
                                                                                                                                                                            <tr>
                                                <td>
                                                    <input type="text" name="order_key[]" value="package" class="form-control order-key" data-validation="required">
                                                </td>
                                                <td>
                                                    <select name="order_key_type[]" class="form-control order-key-type" data-validation="required">
                                                        <option value="table_column" selected>Order Column</option>
                            ...
                            <div class="form-group">
                                ...
                                <table class="table table-bordered" id="tbl-status-request">
                                    ...
                                    <tbody>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <tr>
                                                <td>
                                                    <input type="text" name="status_key[]" value="api_token" class="form-control status-key" data-validation="required">
                                                </td>
                                                <td>
                            ...
                            <div class="form-group">
                                ...
                                <table class="table table-bordered" id="tbl-package-request">
                                    ...
                                    <tbody class="0">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <tr class="1">
                                                <td>
                                                    <input type="text" name="package_key[]" value="api_token" class="form-control package-key" data-validation="required">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                                                                            <input type="text" class="form-control package-key-value" value="packages" name="package_key_value[]" data-validation="required">
                                                                                                    </td>
                                                <td>
                                                    <button
                                                            type="button"
