    ...
    <div class="row">
        <div class="col-md-12 mtn10">
            <div class="mb10">
                ...
                <a href="{{ url('/admin/automate/api/addmxz') }}" class="btn btn-primary btn-sm">Add New (MXZ)</a>
                <a href="{{ url('/admin/automate/api/addperfectpanel') }}" class="btn btn-primary btn-sm">Add New (PerfectPanel's)</a>
            </div>
