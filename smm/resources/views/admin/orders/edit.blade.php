                ...
                <form
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cost" class="form-control" value="{{ $order->cost }}" data-validation-optional="true">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control"
                                          ...
                                          id="custom_comments"
                                                ...
                                                style="resize: none;overflow: hidden;min-height: 50px;">{{ $order->custom_comments }}</textarea>
                            </div>
                        @endif
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label">Premium Account</label>
                            <input type="text" name="license_code" class="form-control" value="{{ $order->license_code }}" data-validation-optional="true">
                        </div>
                        <div class="form-group">
                            <label class="control-label">API ORDER ID</label>
                            <input type="text" name="api_order_id" class="form-control" value="{{ $order->api_order_id }}" data-validation-optional="true">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                <option
                                        value="REFILLING"
                                        {{ $order->status === title_case('REFILLING') ? 'selected' : '' }}
                                >REFILLING
                                </option>                       
                                <option
                                        value="CANCELLING" disabled
                                        {{ $order->status === title_case('CANCELLING') ? 'selected' : '' }}
                                >CANCELLING
                                </option>
