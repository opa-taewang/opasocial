            ...
            <div class="login-form">
                <form
                    ...
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">@lang('forms.edit_user')<a class="btn btn-primary" style="float:right;" href="{{ url('/admin/users/'.$user->id.'/login') }}"><i class="fa fa-user-secret"></i> @lang('new.imitate') </a><a class="btn btn-primary" style="float:right;" href="{{ url('/admin/fund-records/'.$user->id.'') }}"><i class="fa fa-paypal"></i> Fund Records </a></legend>
                        ...
                        <div class="form-group{{ $errors->has('treffund') ? ' has-error' : '' }}">
                            <label for="treffund" class="control-label">Total affiliate Earning</label>
                            <input type="text"
                                   class="form-control"
                                   value="{{ $user->treffund }}"
                                   id="treffund"
                                   data-validation="number" readonly
                                   data-validation-allowing="float"
                                   name="treffund">
                            @if ($errors->has('treffund'))
                                <span class="help-block">
                                        <strong>{{ $errors->first('treffund') }}</strong>
                                    </span>
                            @endif
                        </div>
                        <div class="form-group{{ $errors->has('reffund') ? ' has-error' : '' }}">
                            <label for="reffund" class="control-label">Paid affiliate Earning</label>
                            <input type="text"
                                   class="form-control"
                                   value="{{ $user->reffund }}"
                                   id="reffund"
                                   ...
                                   data-validation-allowing="float"
                                   name="reffund">
                            @if ($errors->has('reffund'))
                                <span class="help-block">
                                        <strong>{{ $errors->first('reffund') }}</strong>
                                    </span>
                            @endif
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                <option
                                        value="{{$group->id}}" {{($user->group_id==$group->id)?'selected':''}}>{{$group->name}}
                                </option>
                                @endforeach
                            </select>
                            @if ($errors->has('group'))
