            ...
            <div class="login-form">
                <form role="form"
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group{{ $errors->has('navbar_name') ? ' has-error' : '' }}">
                            <label for="navbar_name" class="control-label">Navigation Bar Name</label>
                            <input type="text"
                                   class="form-control"
                                   value="{{ $options['navbar_name'] }}"
                                   id="navbar_name"
                                   name="navbar_name">
                            @if ($errors->has('navbar_name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('navbar_name') }}</strong>
                                </span>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="panel_theme" id="panel_theme" class="form-control">
                                ...
                                <option value="fancy" {{ ($options['panel_theme'] == 'fancy') ? 'selected' : '' }}>Fancy</option>
                            </select>
                        ...
                        <div class="form-group{{ $errors->has('google_client_id') ? ' has-error' : '' }}">
                            <label for="google_client_id" class="control-label">Google Client ID</label>
                            <input type="text"
                                   class="form-control"
                        ...
                        <div class="form-group{{ $errors->has('google_client_secret') ? ' has-error' : '' }}">
                            <label for="google_client_secret" class="control-label">Google Client SECRET</label>
                            <input type="text"
                                   class="form-control"
                        ...
                        <div class="form-group{{ $errors->has('google_redirect') ? ' has-error' : '' }}">
                            <label for="google_redirect" class="control-label">Google Redirect/Callback Url</label>
                            <input type="text"
                                   class="form-control"
                                   value="{{config('services.google.redirect')}}"
                                   id="google_redirect" disabled readonly>
                            @if ($errors->has('google_redirect'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('google_redirect') }}</strong>
                                </span>
                            @endif
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    bkLib.onDomLoaded(function() {
     new nicEditor({
        ...
        'unlink',
        'removeformat'
        ]}).panelInstance('home_page_description')
    });
</script>
