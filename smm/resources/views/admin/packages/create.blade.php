        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-form">
                <form
                        ...
                        id="form"
                        method="POST"
                        action="{{ url('/admin/packages') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                <option
                                        value="0"
                                        {{ old('refillbtn') == '0' ? 'selected' : '' }}>No
                                </option>
                                <option
                                        value="1"
                                        {{ old('refillbtn') == '1' ? 'selected' : '' }}>Yes
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                <option
                                        value="No"
                                        {{ old('features') == 'No' ? 'selected' : '' }}>No
                                </option>
                                <option
                                        value="Drip Feed"
                                        {{ old('features') == 'Drip Feed' ? 'selected' : '' }}>@lang('new.df')
                                </option>
                        ...
                        <div class="form-group{{ $errors->has('seller_package_id') ? ' has-error' : '' }}">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('seller_package_id') }}"
                                   name="seller_package_id" readonly>
                        ...
                        <div class="form-group">
                            <button type="submit" id="submit" class="btn btn-primary">@lang('buttons.create')</button>
                        </div>
                    </fieldset>
                </form>
            </div>
            ...
            $(document).ready(function(){
                ...
                Dropzone.options.myDropzone= {
                    ...
                    sending: function(file, xhr, formData) {
                        ...
                        formData.append("trial", $("#trial").val());
