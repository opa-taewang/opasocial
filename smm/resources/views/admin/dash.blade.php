...
@section('content')
    ...
    <div class="col-md-4">
      <div class="card-counter info">
        <i class="fa fa-user-o"></i>
        <span class="count-numbers">{{ getOption('currency_symbol') . number_format($totalUserfunds,2, getOption('currency_separator'), '') }}</span>
        <span class="count-name">@lang('general.total_users') Last 30 Days Funds</span>
      </div>
    </div>
