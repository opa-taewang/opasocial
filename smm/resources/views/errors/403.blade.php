...
<div class="scene">
  ...
  <div class="text">
    ...
    <span class="support">You're blocked in this site because of this reason<br><b>{{ $exception->getMessage() }}</b></span>
    <span class="support">
      <a href="mailto:info@instaraja.com?Subject=Account%20Blocked" target="_top">Admin contact email: info@opasocial.com</a>
    </span>
  </div>
  <div class="lock"></div>
</div>