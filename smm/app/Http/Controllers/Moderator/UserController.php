...
class UserController extends \App\Http\Controllers\Controller
{
    ...
    public function store(\Illuminate\Http\Request $request)
    {
        ...
        \App\User::create(array( "name" => $request->input("name"), "email" => $request->input("email"), "status" => $request->input("status"), "role" => $request->input("role"), "funds" => $request->input("funds"), "skype_id" => $request->input("skype_id"), "enabled_payment_methods" => $payment_methods, "password" => bcrypt($request->input("password")) ));
    ...
    public function packageSpecialPrices($id, \Illuminate\Http\Request $request)
    {
        ...
        {
            $min_regular_price = (double) $pricePerItems[$packageId] * $minimumQuanties[$packageId];
